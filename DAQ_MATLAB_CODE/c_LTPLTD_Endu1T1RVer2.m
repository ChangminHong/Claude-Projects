...
input_unit_set_mode         = [ [mydc_chennal_adder(0, set_unit_pulse_input, 0), tr_set_unit_pulse_input];...
                                [flip(mydc_chennal_adder(0, read_unit_pulse_input, 0), 2), tr_read_unit_pulse_input]];
input_unit_reset_mode       = [ [mydc_chennal_adder(0, reset_unit_pulse_input, 0), tr_reset_unit_pulse_input];...
                                [flip(mydc_chennal_adder(0, read_unit_pulse_input, 0), 2), tr_read_unit_pulse_input]];
% ------------------------------
...
% ----------------------------------
currentFolder = pwd;
    if ~isfolder('c_LTPLTD_EnduVer2')
        mkdir c_LTPLTD_EnduVer2
    end
    cd(currentFolder);
    cd('c_LTPLTD_EnduVer2');
...
fprintf("c_LTPLTD_EnduVer2 END\n");
%   Copyright (c) 2022 by ENTIS, All rights reserved.
% 
%   File name  : c_LTPLTD_EnduVer2.m
