...
PARA.MUX_READ_PULSE_ON   = 0;
PARA.MUX_RESET_PULSE_ON  = 1;
...
xlabel("Scan Data (#)")
ylabel("Voltage (V)")
legend({'input', 'MUX'},'Location','best')
grid on
...
% ----------------------------------
currentFolder = pwd;
    if ~isfolder('b_LTPLTD_EnduVer2')
        mkdir b_LTPLTD_EnduVer2
    end
    cd(currentFolder);
    cd('b_LTPLTD_EnduVer2');
...
fprintf("b_LTPLTD_EnduVer2 END\n");
%   Copyright (c) 2022 by ENTIS, All rights reserved.
% 
%   File name  : b_LTPLTD_EnduVer2.m
