...
% ----------------------------------
currentFolder = pwd;
    if ~isfolder('b_LTPLTD_Endu_stairs_set_Ver2')
        mkdir b_LTPLTD_Endu_stairs_set_Ver2
    end
    cd(currentFolder);
    cd('b_LTPLTD_Endu_stairs_set_Ver2');
...
fprintf("b_LTPLTD_Endu_stairs_set_Ver2 END\n");
%   Copyright (c) 2022 by ENTIS, All rights reserved.
% 
%   File name  : b_LTPLTD_Endu_stairs_set_Ver2.m
